...
namespace BDEngine
{
	...
	void BDBuffer::createBuffer(const VkDevice* logicalDevice, const VkPhysicalDevice* physicalDevice, 
	...
	void BDBuffer::cleanupBuffer(const VkDevice* logicalDevice, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
	{
		vkDestroyBuffer(*logicalDevice, buffer, nullptr);
		vkFreeMemory(*logicalDevice, bufferMemory, nullptr);
	}

	uint32_t BDBuffer::findMemoryType(VkPhysicalDevice physicalDevice, uint32_t typeFilter, VkMemoryPropertyFlags properties)
	{
	...
	void BDBuffer::copyBuffer(const VkDevice* logicalDevice, const VkCommandPool* commandPool, VkBuffer srcBuffer,
