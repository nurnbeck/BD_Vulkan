...
namespace BDEngine
{
	BDIndexBuffer::BDIndexBuffer(const VkDevice* logicalDevice, const VkPhysicalDevice* physicalDevice, const VkSurfaceKHR* surface,
	...
	void BDIndexBuffer::CleanupIndexBuffer(const VkDevice* logicalDevice)
	{
