...
namespace BDEngine
{
	...
	void BDSwapchain::Create(const VkDevice* logicalDevice, VkPhysicalDevice* physicalDevice, const VkSurfaceKHR* surface, Window* windowObj,SwapChainSupportDetails swapChainSupport)
	{
	...
	void BDSwapchain::CleanupFramebuffers()
	{
	...
	void BDSwapchain::CreateImageViews()
	{
	...
	void BDSwapchain::CreateFramebuffers(VkRenderPass* renderPass)
	{
	...
	VkSurfaceFormatKHR BDSwapchain::ChooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
	{
	...
	VkPresentModeKHR BDSwapchain::ChooseSwapPresentMode(const std::vector<VkPresentModeKHR> availablePresentModes)
	{
		/*
	...
	VkExtent2D BDSwapchain::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, Window windowObj)
	{
