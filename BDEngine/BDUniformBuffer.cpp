...
namespace BDEngine
{
	...
	BDUniformBuffer::BDUniformBuffer(const VkDevice* logicalDevice, const VkPhysicalDevice* physicalDevice, const VkSurfaceKHR* surface,
	...
	BDUniformBuffer::~BDUniformBuffer()
	{
	}

	void BDUniformBuffer::CreateUniformBuffer(const VkDevice* logicalDevice, const VkPhysicalDevice* physicalDevice, const VkSurfaceKHR* surface,
		const VkCommandPool* transferCommandPool, const VkQueue* transferQueue)
	{
	...
	void BDUniformBuffer::CleanupUniformBuffer(const VkDevice* logicalDevice)
	{
		cleanupBuffer(logicalDevice, buffer, bufferMemory);
	}

	void BDUniformBuffer::Update(const VkDevice* logicalDevice, const VkExtent2D &swapChainExtent)
	{
